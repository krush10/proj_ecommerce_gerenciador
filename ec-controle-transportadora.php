...
<title>Controle Transportadora - Gerenciador Ecommerce</title>
<link rel="stylesheet" href="css/header_style.css" type="text/css" media="all" />
<link rel="stylesheet" href="css/ec_controle_transportadora_style.css" type="text/css" media="all" />
    ...
    <div class="corpo">
        ...
        <div id="area_busca">
            ...
            <table id="table_busca"  style='margin-left: 7px;'>
                <tr>
                    <td><input type="text" name="nome_transportadora" class="campo" value=" Transportadora" /></td>
                </tr>
            </table>
        ...
        <div id="faixa">
            <img src="img/faixa_controle_transportadora.png" />
        </div>
        <div id="contexto">
            <?php 
                        
                    $campos_query = "*";
                    $final_query = "FROM transportadora";
                    $maximo = 12;
                    ...
                    echo "<table id='conteudo'>";
                        ...
                        while($array = mysql_fetch_array($recuperar_categorias)){
                            $id = $array['id'];
                            $nome_transportadora = $array['nome_transportadora'];
                            $cidade = $array['cidade'];
                            $estado = $array['estado'];
                            ...
                            echo "<tr style='background: #FFF'>";
                                echo "<td>$nome_transportadora</td>";
                                echo "<td>$telefone</td>";
                                echo "<td><a href='ec-dados-transportadora.php?transportadora=$id'><img src='img/btn_dados.png' border='0' /></a></td>";
                                echo "<td><a href='javascript:void(0)' onclick='excluirTransportadora($id)'><img src='img/btn_excluir.png' border='0' /></a></td>";
                    ...
                    echo "<div id='paginador'>";
                        ...
                        if($pgs > 1 ) {
                                ...
                                if($menos >= 0) {
                                        ...
                                        echo "<a title='in&iacute;cio' style='text-decoration:none;' href=http://".$_SERVER['SERVER_NAME']."/proj_ecommerce_gerenciador/ec-controle-transportadora.php?p=><strong>in&iacute;cio</strong> </a>";
                                }
                                ...
                                if($menos >= 1) {
                                        ...
                                        echo "<a title='Anterior' style='text-decoration:none;' href=http://".$_SERVER['SERVER_NAME']."/proj_ecommerce_gerenciador/ec-controle-transportadora.php?p=".($i)."><strong>anterior</strong> </a>";
                                }

                                // Listando as paginas
                                for($i=$pagina; $i<$pagina+3; $i++) {
                                        if($i != $pagina) {
                                                echo " <a href="."http://".$_SERVER['SERVER_NAME']."/proj_ecommerce_gerenciador/ec-controle-transportadora.php"."?p=".($i).">$i</a> <font color='#CCCCCC'>|</font>";
                                ...
                                if($mais <= $pgs) {
                                        ...
                                        echo " <a title='Pr&oacute;xima' style='text-decoration:none;' href="."http://".$_SERVER['SERVER_NAME']."/proj_ecommerce_gerenciador/ec-controle-transportadora.php"."?p=".($i)."> <strong>pr&oacute;xima</strong></a>";
                                }
                                if(($mais >= $pgs) || ($mais <= $pgs)) {

                                        echo " <a title='ultima p&aacute;gina' style='text-decoration:none;' href="."http://".$_SERVER['SERVER_NAME']."/proj_ecommerce_gerenciador/ec-controle-transportadora.php"."?p=".($pgs)."> ultima p&aacute;gina</a>";
                                }
                            }
                    echo "</div>";
        ...
        <div id="btn_cadastrar">
            <a href="ec-cadastra-transportadora.php"><img src="img/btn_novo.png" border="0"/></a>
        </div>
    </div>
