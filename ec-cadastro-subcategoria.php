...
<title>Adicionar Nova Sub-Categoria - Gerenciador Ecommerce</title>
<link rel="stylesheet" href="css/header_style.css" type="text/css" media="all" />
<link rel="stylesheet" href="css/ec_cadastro_subcategoria_style.css" type="text/css" media="all" />
...
<body>
    ...
    <div class="corpo">
        ...
        <div id="faixa">
        	<img src="img/faixa_adicionar_subcategoria.png" />
        </div>
        <div id="contexto">
            <form id="cad_sub_categoria" action="gerenciador.ecommerce.controller/CadastroSubCategoriaController.php" method="post">
                <table id="conteudo">
                    <tr>
                        <td width="162">Nome da Sub-Categoria</td>
                        <td><input type="text" name="nome_sub_categoria" class="caixa" /></td>
                    <?php 
                    
                        $buscar_categoria = mysql_query("SELECT * FROM categoria ORDER BY nome_categoria ASC");
                        
                        echo "<td>";
                        echo "<select name='id_categoria' class='selecionar'>";
