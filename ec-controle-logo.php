...
<link rel="stylesheet" href="css/ec_controle_logo_style.css" type="text/css" media="all" />
...
<body>
    ...
    <div class="corpo">
        ...
        <div id="faixa">
        	<img src="img/faixa_controle_logo.png" />
        </div>
        <div id="contexto">
        	<form action="" method="post">
                <table id="conteudo">
                    <tr>
                        <td width="160">Insira uma nova logo</td>
