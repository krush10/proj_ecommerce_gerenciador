...
<title>Adicionar Nova Transportadora - Gerenciador Ecommerce</title>
<link rel="stylesheet" href="css/header_style.css" type="text/css" media="all" />
<link rel="stylesheet" href="css/ec_cadastra_transportadora_style.css" type="text/css" media="all" />
...
<body>
    ...
    <div class="corpo">
        ...
        <div id="faixa">
            <img src="img/faixa_adicionar_transportadora.png" />
        </div>
        <div id="contexto">
            <form action="gerenciador.ecommerce.controller/CadastroTransportadoraController.php" method="post">
                <table id="conteudo">
                    <tr>
                        <td>Nome Transportadora</td>
                        <td><input type='text' name='nome_transportadora' class='caixa'/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>CNPJ</td>
                        <td><input type="text" name="cnpj" class="caixa"/></td>
                    </tr>
                </table>
                <table>
                    <tr>
