...
<title>Adicionar Nova Categoria - Gerenciador Ecommerce</title>
<link rel="stylesheet" href="css/header_style.css" type="text/css" media="all" />
<link rel="stylesheet" href="css/ec_cadastro_categoria_style.css" type="text/css" media="all" />
...
<body>
    ...
    <div class="corpo">
        ...
        <div id="faixa">
        	<img src="img/faixa_adicionar_categoria.png" />
        </div>
        <div id="contexto">
            <form id="cad_categoria" action="gerenciador.ecommerce.controller/CadastroCategoriaController.php" method="post">
                <table id="conteudo">
                    <tr>
                        <td width="162">Nome da Categoria</td>
                        <td><input type="text" name="nome_categoria" class="caixa" /></td>
                    </tr>
                    <tr>
                        <td width="162">Destaque</td>
                        <td>
