...
<title>Dados Loja - Gerenciador Ecommerce</title>
<link rel="stylesheet" href="css/header_style.css" type="text/css" media="all" />
<link rel="stylesheet" href="css/ec_dados_loja_style.css" type="text/css" media="all" />
...
<body>
    ...
    <div class="corpo">
        ...
        <div id="faixa">
        	<img src="img/faixa_cadastro_loja.png" />
        </div>
        <div id="contexto">
        	<form action="" method="post">
                <table id="conteudo">
                    <tr>
                        <td width="160">Nome da Loja</td>
                        <td><input type="text" name="" class="caixa" /></td>
                    </tr>
                    <tr><td></td></tr>
                    <tr>
                        <td width="160">Email da Loja</td>
                        <td><input type="text" name="" class="caixa" /></td>
                    </tr>
                    <tr><td></td></tr>
                    <tr>
                        <td width="160">Telefone da Loja</td>
                        <td><input type="text" name="" class="caixa" /></td>
                    </tr>
                </table>
                <table>
